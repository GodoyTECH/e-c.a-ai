...
export function Storefront({ categories, products }: { categories: Category[]; products: Product[] }) {
  ...
  return (
    <main className="mx-auto max-w-6xl p-4 md:p-8">
      <section className="mb-6 rounded-3xl bg-gradient-to-r from-acai to-purple-500 p-6 text-white">
      ...
      <Link href="/checkout" className="fixed bottom-4 right-4 rounded-full bg-acai px-5 py-3 font-bold text-white shadow-xl">
